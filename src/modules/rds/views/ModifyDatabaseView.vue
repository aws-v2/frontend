...
<template>
    <div class="min-h-screen bg-white text-[#16191f] font-urbanist selection:bg-amber-500/20 selection:text-amber-900">
        <div class="relative pt-24 pb-40">
            ...
            <!-- Breadcrumbs -->
            <nav
                class="relative z-10 flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.3em] px-8 py-6 bg-white border-b border-[#eaeded]">
            ...
            <div class="relative z-10 px-8 py-10 max-w-7xl mx-auto">
                ...
                <div class="aws-card p-6 rounded-sm mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-[11px] text-gray-500 mb-2">Version number of the database engine to be used for
                            this
                            database</p>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-[11px] text-gray-500 mb-2">Type a name for your DB cluster. The name must be
                            unique
                        ...
                        <p class="text-[10px] text-gray-500 mt-1 italic">The DB cluster identifier is case-insensitive,
                            but
                            is stored as all lowercase (as in "mydbcluster"). Constraints: 1 to 63 alphanumeric
                            characters
                            or hyphens. First character must be a letter. Can't contain two consecutive hyphens. Can't
                            end
                            with a hyphen.</p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-[11px] text-gray-500 mb-3">You can use AWS Secrets Manager or manage your master
                            user
                            credentials.</p>
                        <div class="grid grid-cols-2 gap-4">
                            <div @click="credentialManagement = 'aws-secrets-manager'"
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 class="text-xs font-bold text-gray-800">Managed in AWS Secrets Manager -
                                            most
                                            secure</h4>
                    ...
                    <div v-if="credentialManagement === 'aws-secrets-manager'"
                        ...
                        <p class="text-[11px] text-gray-700">
                            ...
                            If you manage the master user credentials in AWS Secrets Manager, additional charges apply.
                            See
                    ...
                    <div class="border-t border-gray-100 pt-4">
                        <button @click="showAdditionalCredentials = !showAdditionalCredentials"
                            ...
                            <svg class="w-3.5 h-3.5 transition-transform"
                                ...
                                <path d="M5 15l7-7 7 7" stroke-width="2" stroke-linecap="round"
                        ...
                        <div v-if="showAdditionalCredentials" class="mt-4 space-y-4">
                            <label class="flex items-start gap-2 cursor-pointer">
                                ...
                                <div>
                                    <span class="text-xs font-bold text-gray-700 block">IAM database
                                        authentication</span>
                        ...
                        <div @click="storageConfig = 'aurora-standard'"
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <ul class="text-[10px] text-gray-500 mt-1 list-disc ml-4 space-y-1">
                                        <li>Cost-effective pricing for many applications with moderate I/O usage (I/O
                                            costs
                                            <25% of total database costs).</li>
                                        <li>Pay-per-request I/O charges apply. DB instance and storage prices don't
                                            include
                                            I/O usage.</li>
                                    </ul>
                                </div>
                ...
                <div class="aws-card p-6 rounded-sm mb-6">
                    ...
                    <div class="mb-6">
                        <h4 class="text-xs font-bold text-gray-700 mb-1">Pause after inactivity <span
                                class="text-[var(--aws-blue)] text-[10px]">Info</span></h4>
                        <p class="text-[11px] text-gray-500 mb-2">Clusters with a minimum capacity setting of 0.5 ACUs
                            can
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-sm p-3 flex items-start gap-2">
                            ...
                            <p class="text-[11px] text-gray-700">The capacity range applies to all Serverless v2
                                instances
                ...
                <div class="aws-card p-6 rounded-sm mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-[11px] text-gray-500 mb-2">Choose one or more VPC security groups to allow access
                            to
                            your database. Make sure that the security group rules allow the appropriate incoming
                            traffic.
                        </p>
                        <div class="relative">
                ...
                <div class="aws-card p-6 rounded-sm mb-6">
                    ...
                    <label class="flex items-start gap-2 cursor-pointer">
                        ...
                        <div>
                            ...
                            <span class="text-[10px] text-gray-500">Allows write operations from reader DB instances
                                within
                ...
                <div class="aws-card p-6 rounded-sm mb-6">
                    ...
                    <p class="text-[11px] text-gray-500 mb-4">Choose monitoring tools for this database. Database
                        Insights
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div @click="monitoringType = 'advanced'"
                            class="aws-card p-4 rounded-sm cursor-pointer border-2"
                        ...
                        <div @click="monitoringType = 'standard'"
                            class="aws-card p-4 rounded-sm cursor-pointer border-2"
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <ul class="text-[10px] text-gray-500 mt-1 list-disc ml-4 space-y-1">
                                        <li>Retains 7 days of performance history, with the option to pay for the
                                            retention
                    ...
                    <div class="mb-6">
                        ...
                        <label class="flex items-start gap-2 cursor-pointer mb-4">
                            ...
                            <div>
                                ...
                                <span class="text-[10px] text-gray-500">With Performance Insights dashboard, you can
                                    visualize the database load on your Amazon RDS DB instance load and filter the load
                                    by
                        ...
                        <div v-if="performanceInsights" class="space-y-4 max-w-2xl ml-6">
                            ...
                            <div
                                class="bg-yellow-50 border border-yellow-200 rounded-sm p-3 flex items-start gap-2 mt-4">
                                <svg class="w-4 h-4 text-yellow-600 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"
                                        clip-rule="evenodd" />
                                </svg>
                                <p class="text-[11px] text-gray-700 font-bold uppercase">You can't change the KMS key
                                    after
                    ...
                    <div class="border-t border-gray-100 pt-4">
                        ...
                        <p class="text-[10px] text-gray-500 ml-6">Enhanced Monitoring, CloudWatch Logs and DevOps Guru
                        </p>
                        ...
                        <div v-if="showAdditionalMonitoring" class="mt-6 space-y-6 max-w-4xl ml-6">
                            <div>
                                ...
                                <label class="flex items-start gap-2 cursor-pointer">
                                    <input type="checkbox" v-model="enhancedMonitoring"
                                        class="w-4 h-4 mt-0.5 rounded-sm" />
                                    <div>
                                        <span class="text-xs font-bold text-gray-700 block">Enable Enhanced
                                            monitoring</span>
                                        <span class="text-[10px] text-gray-500 leading-tight">Enabling Enhanced
                                            Monitoring
                            ...
                            <div v-if="enhancedMonitoring" class="grid grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <p class="text-[10px] text-gray-500 mt-1 leading-tight">The monitoring role is an
                                        IAM
                                        role that allows RDS to send Enhanced Monitoring metrics to Amazon CloudWatch
                                        Logs.
                                        Choose an existing monitoring role, or choose **default** to have RDS
                                        automatically
                ...
                <div class="aws-card rounded-sm mb-6">
                    <div @click="showAdditionalConfig = !showAdditionalConfig"
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-gray-500 mt-0.5">Database options, backup turned on, backtrack
                                turned
                                off, Enhanced Monitoring turned on, maintenance, CloudWatch Logs, delete protection
                                turned
                                off</p>
                        </div>
                    </div>
                            ...
                            <div class="space-y-6 max-w-2xl">
                                <div>
                                    <label class="aws-label mb-1">Backup retention period <span
                                            class="text-[var(--aws-blue)] text-[10px] font-normal ml-1">Info</span></label>
                                    <p class="text-[11px] text-gray-500 mb-2">The number of days (1-35) for which
                                        automatic
                                        backups are kept.</p>
                                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <div class="space-y-6 max-w-3xl">
                                <label class="flex items-start gap-2 cursor-pointer">
                                    ...
                                    <div>
                                        <span
                                            class="text-xs font-bold text-gray-700 block text-[var(--aws-blue)]">Enable
                                            auto minor version upgrade <span
                                                class="text-[var(--aws-blue)] font-normal ml-1 italic">Info</span></span>
                                        <span class="text-[10px] text-gray-500 leading-tight">Enabling auto minor
                                            version
                                            upgrade will automatically upgrade your database minor version. For
                                            limitations
                                            and more details, see <a href="#"
                                                class="text-[var(--aws-blue)] hover:underline">Automatically upgrading
                                                the
                                ...
                                <label class="flex items-start gap-2 cursor-pointer">
                                    <input type="checkbox" v-model="deletionProtection"
                                        class="w-4 h-4 mt-0.5 rounded-sm" />
                                    <div>
                                        ...
                                        <span class="text-[10px] text-gray-500 leading-tight">Protects the database from
                                            being deleted accidentally. While this option is enabled, you can't delete
                                            the
                                            database.</span>
                                    </div>
                                </label>
